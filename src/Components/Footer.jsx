...
function Footer() {
  return (
    <div className='w-full h-screen bg-zinc-900 p-20 flex gap-5 font-["Founders Grotesk"]'>
        <div className='w-1/2 h-full flex flex-col justify-between'>
            <div className="heading">
            <h1 className='text-[7vw] font-semibold uppercase leading-none -mb-5 tracking-tighter'>Eye-</h1>
            <h1 className='text-[7vw] font-semibold uppercase leading-none -mb-5 tracking-tighter'>Opening</h1>
            </div>
            ...
            <div className='w-1/2'>
                <h1 className='text-[7vw] font-semibold uppercase leading-none -mb-5 tracking-tighter'>Presentaions</h1>
                <div className='dets font-["Neue_Montreal"] mt-8'>
                    <a className='block text-xl font-light ' href="#"> Facbook</a>
                    <a className='block text-xl font-light' href="#">Instgram</a>
